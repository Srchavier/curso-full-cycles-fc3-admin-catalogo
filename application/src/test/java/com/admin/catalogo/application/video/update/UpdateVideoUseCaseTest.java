package com.admin.catalogo.application.video.update;
...
import com.admin.catalogo.domain.exceptions.InternalErrorException;
...
import com.admin.catalogo.domain.video.AudioVideoMedia;
import com.admin.catalogo.domain.video.ImageMedia;
import com.admin.catalogo.domain.video.MediaResourceGateway;
import com.admin.catalogo.domain.video.MediaStatus;
...
public class UpdateVideoUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidCommand_whenCallsUpdateVideo_shouldReturnVideoId() {
        ...
        final Resource expectedThumbHalf = Fixture.Videos.resource(Resource.Type.THUMBNAILHALF);
